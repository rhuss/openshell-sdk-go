...
func TestNewClient_AuthModeNone(t *testing.T) {
	setupGateway(t, "test-gw", `{"endpoint":"localhost:50051","auth_mode":"none"}`)
...
func TestNewClient_AuthModePlaintext(t *testing.T) {
	setupGateway(t, "plain-gw", `{"endpoint":"localhost:50051","auth_mode":"plaintext"}`)
...
func TestNewClient_AuthModeCloudflareJWT(t *testing.T) {
	setupGatewayWithTokens(t, "cf-gw",
		`{"endpoint":"localhost:50051","auth_mode":"cloudflare_jwt"}`,
...
func TestNewClient_AuthModeOIDC(t *testing.T) {
	setupGatewayWithTokens(t, "oidc-gw",
		`{"endpoint":"localhost:50051","auth_mode":"oidc"}`,
...
func TestNewClient_MissingEdgeToken(t *testing.T) {
	setupGateway(t, "no-token-gw", `{"endpoint":"localhost:50051","auth_mode":"cloudflare_jwt"}`)
...
func TestNewClient_MissingOIDCToken(t *testing.T) {
	setupGateway(t, "no-oidc-gw", `{"endpoint":"localhost:50051","auth_mode":"oidc"}`)
...
func TestNewClient_MTLSUnsupported(t *testing.T) {
	setupGateway(t, "mtls-gw", `{"endpoint":"localhost:50051","auth_mode":"mtls"}`)
...
func TestNewClient_WithAuthOverride(t *testing.T) {
	setupGateway(t, "override-gw", `{"endpoint":"localhost:50051","auth_mode":"cloudflare_jwt"}`)
...
func TestNewClient_WithLogger(t *testing.T) {
	setupGateway(t, "logger-gw", `{"endpoint":"localhost:50051","auth_mode":"none"}`)
...
func TestNewClient_WithOptions(t *testing.T) {
	setupGateway(t, "opts-gw", `{"endpoint":"localhost:50051","auth_mode":"none"}`)
...
func TestNewClient_NoCredentialLeaks(t *testing.T) {
	...
	setupGateway(t, "no-edge-gw", `{"endpoint":"localhost:50051","auth_mode":"cloudflare_jwt"}`)
	cfg := &Config{
...
func TestResolveAuthProvider_NoTokenLeaks(t *testing.T) {
	...
	require.NoError(t, os.MkdirAll(gwDir, 0o755))
	writeFile(t, gwDir, "metadata.json", `{"endpoint":"localhost:50051","auth_mode":"cloudflare_jwt"}`)
...
func TestLoadConfig_ValidConfig(t *testing.T) {
	setupGateway(t, "cfg-gw", `{"endpoint":"host:443","auth_mode":"oidc","name":"ignored"}`)
...
func TestLoadConfig_FrozenSnapshot(t *testing.T) {
	xdg := setupGateway(t, "snap-gw", `{"endpoint":"original:443","auth_mode":"none"}`)
	...
	writeFile(t, gwDir, "metadata.json", `{"endpoint":"modified:443","auth_mode":"none"}`)
...
func TestNewClient_ActiveGateway(t *testing.T) {
	tmp := setupGateway(t, "active-gw", `{"endpoint":"localhost:50051","auth_mode":"none"}`)
...
func TestLoadConfig_ActiveGateway(t *testing.T) {
	tmp := setupGateway(t, "my-active", `{"endpoint":"host:443","auth_mode":"oidc"}`)
